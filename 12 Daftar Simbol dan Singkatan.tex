\vspace{2cm}
\begin{center}
{\fontsize{14}{16.8}\selectfont\textbf{DAFTAR SIMBOL DAN SINGKATAN}}\\[1em]
\end{center}
\label{chap:simbol-singkatan}
\addcontentsline{toc}{chapter}{DAFTAR SIMBOL DAN SINGKATAN}
...
% ============================================================
% SECTION 2: DAFTAR SIMBOL
% ============================================================

\label{sec:daftar-simbol}
\vspace{0.8em}

\begin{longtable}{@{} l >{\raggedright\arraybackslash}p{6.5cm} c @{}}
\multicolumn{1}{l}{\textbf{Simbol}} & \multicolumn{1}{l}{\textbf{Deskripsi}} & \multicolumn{1}{l}{\parbox[c]{3.5cm}{\raggedright \textbf{Pemakaian pertama kali}}} \\
