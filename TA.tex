...
\usepackage[singlelinecheck=false]{caption} % for customizing captions
...
%\usepackage{mathptmx} %  font Times New Roman untuk teks dan matematika
...
% --- Ubah nama daftar listing ke "DAFTAR KODE PROGRAM" ---
...
% --- Gambar ---
\captionsetup[figure]{labelsep=space, format=hang, justification=centering} % gambar di tengah
\floatsetup[figure]{capposition=bottom} % posisi caption di bawah gambar
% --- Tabel ---
\captionsetup[table]{labelsep=space, format=hang, justification=raggedright} % tabel rata kiri
\floatsetup[table]{capposition=top} % posisi caption di atas tabel
% --- Kode Program ---
\captionsetup[lstlisting]{labelsep=space, format=hang, justification=raggedright}
\floatsetup[lstlisting]{capposition=top}
% --- Algoritma ---
%\captionsetup[algorithm]{labelsep=space, format=hang, justification=raggedright}
...
% --- atau pindahkan ke bagian setelah \mainmatter jika hanya ingin halaman isi yang bolak-balik ---
