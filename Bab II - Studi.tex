...
\begin{figure}[t] % pilihan opsi yang disarankan: t = top, b = bottom, h = here
  ...
  \captionsetup{justification=centering}
	...
	{\caption{Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book} \par}
...
Contoh tabel dapat dilihat pada Tabel \ref{tab:tabel1} dan \ref{tab:tabel2}. Tabel dan judulnya dibuat rata kiri dan judul tabel diletakkan di atas tabel. Usahakan tabel dapat ditulis dalam satu halaman, tidak terpotong ke halaman berikutnya.
...
\begin{table}[t] % pilihan opsi yang disarankan: t = top, b = bottom, h = here
  \centering
  \caption{Tabel yang lebar kolomnya dibuat tetap (\textit{fixed width}) menggunakan \texttt{p\{width\}}. \textit{Header} tabel juga dibuat tebal menggunakan perintah \texttt{textbf\{\}}.}
  \label{tbl:tabel3}
...
Tabel \ref{tab:tabel4} diimpor dari berkas eksternal \texttt{table/tabel1.tex} menggunakan perintah \texttt{input}. 
...
seperti pada Tabel \ref{tab:longtable1}.

\begin{longtable}{@{\extracolsep{\fill}} l c r r}
\caption{Comprehensive Data Table Example}\label{tab:longtable1} \\
\midrule
